...
app.use(function (req, res) {
    ...
    var data = { routes: routes, location: req.url };

    match(data, function (error, redirectLocation, renderProps) {
        ...
        if (error) {
            ...
            res.end(renderToString(React.createElement(RouterContext, renderProps)));
        } else {
